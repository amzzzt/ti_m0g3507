...
#define TFT180_SPI                      ( SPI_1            )                    // 硬件 SPI 号: SPI1
#define TFT180_SCL_PIN                  ( SPI1_SCK_B9      )                    // 硬件 SPI SCK 引脚: PB9
#define TFT180_SDA_PIN                  ( SPI1_MOSI_B8     )                    // 硬件 SPI MOSI 引脚: PB8
//====================================================硬件 SPI 驱动====================================================
#endif

#define TFT180_RES_PIN                  ( B10 )                                 	// 液晶复位引脚定义: PB10
#define TFT180_DC_PIN                   ( B11 )                                 // 液晶命令位引脚定义: PB11
#define TFT180_CS_PIN                   ( B14 )                                 // CS 片选引脚: PB14
#define TFT180_BL_PIN                   ( B26 )                                 // 液晶背光引脚定义: PB26
